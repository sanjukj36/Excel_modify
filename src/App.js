...
//   const [undoActionData, setUndoActionData] = useState([]);
//   const [redoActionData, setRedoActionData] = useState([]);
...
//   //     setUndoActionData((prev) => [...prev, json]);
...
//       // Use a generator to read in chunks
...
//         setData([...chunkedData]); // update UI incrementally
//         await new Promise((r) => setTimeout(r, 0)); // yield control to browser
//       }

//       setOriginalData(json);
//       setUndoActionData([json]);
//       if (json.length > 0 && Object.keys(json[0]).length > 0) {
//         setSelectedColumn(Object.keys(json[0])[0]);
//       }
//     };
...
//     }));
//     setUndoActionData((prev) => [...prev, data]);
//     setData(cleaned);
//   };
...
//     if (!undoActionData || undoActionData.length === 0) return;

//     const lastAction = undoActionData.pop();
//     console.log("Undoing action:", lastAction);
//     setData(lastAction)
//     setRedoActionData((prev) => [...prev, data])
//     setUndoActionData([...undoActionData]);

//   };

//   const redoLastAction = () => {
//     if (!redoActionData || redoActionData.length === 0) return;

//     const lastAction = redoActionData.pop();
//     setData(lastAction)
//     setUndoActionData((prev) => [...prev, lastAction]);
...
//                 </div>
//                 <div className="bg-black/20 flax-1 gap-1">
...
//                     className="flex-1 bg-blue-500 hover:bg-blue-600 text-white font-medium px-4 py-2.5 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-sm hover:shadow-md"
//                   >
//                     <svg
//                       className="w-4 h-4"
//                       fill="none"
...
//                         strokeWidth={2}
//                         d="M12 5v4H8m0 0l4-4m-4 4l4 4M8 9a9 9 0 019 9h3"
//                       />
//                     </svg>
//                     Undo
//                   </button>
...
//                     className="flex-1 bg-green-500 hover:bg-green-600 text-white font-medium px-4 py-2.5 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-sm hover:shadow-md"
//                   >
//                     <svg
