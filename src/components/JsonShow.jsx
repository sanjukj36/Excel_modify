...
//   // ✅ Transform input data to required structure
...
//         <pre className="text-sm font-mono bg-gray-50 p-4 rounded-lg border border-gray-200 h-full">
...
export default React.memo(function JsonShow({ data }) {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-40px)] bg-white rounded-2xl shadow-lg border border-gray-200">
      ...
      {/* JSON Content */}
      <div className="flex-1 overflow-auto p-6">
        <pre className="text-sm font-mono bg-gray-50 p-4 rounded-lg  h-full">
          <code>{formattedJson}</code>
        </pre>
      </div>
